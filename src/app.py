...
activities = {
    ...
    "Basketball Team": {
        "description": "Competitive basketball practice and interschool games",
        "schedule": "Mondays, Wednesdays, Fridays, 4:00 PM - 6:00 PM",
        "max_participants": 15,
        "participants": ["liam@mergington.edu", "noah@mergington.edu"]
    },
    "Soccer Club": {
        "description": "Recreational soccer practice and weekend matches",
    ...
    "Science Club": {
        "description": "Hands-on experiments, club projects, and science fairs",
